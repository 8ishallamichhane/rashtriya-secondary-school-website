document.addEventListener('DOMContentLoaded', function() {
    ...
    const map = new H.Map(
        ...
        {
            zoom: 16,
            center: { lat:27.650719099072756, lng: 82.86995499643587 } // Chandrauta, Kapilvastu coordinates
        }
    );
    ...
    const schoolMarker = new H.map.Marker({
        lat: 27.6167,
        lng: 83.1167  // Chandrauta, Kapilvastu coordinates
    });

    // Create an info bubble
    const bubble = new H.ui.InfoBubble(
        { lat: 27.6167, lng: 83.1167 }, // Chandrauta, Kapilvastu coordinates
        {
            content: `
